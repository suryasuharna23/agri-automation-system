"""
Training script for crop quality grading model (Grade A/B/C).
...
def train(data_dir: str, output_dir: str):
    ...
    model = build_model(num_classes=len(GRADES)).to(device)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), output_path / "grading_model.pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-dir", default="data/grading")
