...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 13, fontFamily: "FacultyGlyphic_400Regular", color: "#55835e" },
  ...
  desc: { fontSize: 13, fontFamily: "FacultyGlyphic_400Regular", color: "#1a3d1f", lineHeight: 20 },
  ...
  primaryText: { fontSize: 14, fontFamily: "FacultyGlyphic_400Regular", color: "#fbf2d4" },
  ...
  dangerText: { fontSize: 14, fontFamily: "FacultyGlyphic_400Regular", color: "#923333" },
});
